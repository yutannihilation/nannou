...
pub struct Context<'a, S = geom::scalar::Default> {
    ...
    S: BaseFloat,
{
    ...
    draw_commands: Vec<Option<DrawCommand<'a, S>>>,
    ...
    S: BaseFloat,
{
    ...
    fn finish_remaining_drawings(&'a mut self) {
    ...
    pub(crate) fn finish_drawing(&'a mut self, index: usize) {
    ...
    S: BaseFloat,
{
    ...
    pub fn transform(&'a self, transform_matrix: Matrix4<S>) -> Self {
    ...
    pub fn translate(&'a self, v: geom::Vector3<S>) -> Self {
    ...
    /// each axis.
    pub fn scale_axes(&'a self, v: geom::Vector3<S>) -> Self {
    ...
    /// x axis
    pub fn scale_x(&'a self, s: S) -> Self {
        self.scale_axes(geom::vec3(s, S::zero(), S::zero()))
    }

    /// Produce a new **Draw** instance where the contents are scaled by the given amount along the
    /// y axis
    pub fn scale_y(&'a self, s: S) -> Self {
        self.scale_axes(geom::vec3(S::zero(), s, S::zero()))
    }

    /// Produce a new **Draw** instance where the contents are scaled by the given amount along the
    /// z axis
    pub fn scale_z(&'a self, s: S) -> Self {
    ...
    /// accordingly.
    pub fn euler(&'a self, euler: cgmath::Euler<cgmath::Rad<S>>) -> Self {
        self.transform(euler.into())
    }

    /// Specify the orientation with the given **Quaternion**.
    pub fn quaternion(&'a self, q: cgmath::Quaternion<S>) -> Self {
    ...
    pub fn radians(&'a self, v: geom::Vector3<S>) -> Self {
    ...
    pub fn x_turns(&'a self, x: S) -> Self {
        self.x_radians(turns_to_rad(x))
    }

    /// Specify the orientation around the *y* axis as a number of turns around the axis.
    pub fn y_turns(&'a self, y: S) -> Self {
        self.y_radians(turns_to_rad(y))
    }

    /// Specify the orientation around the *z* axis as a number of turns around the axis.
    pub fn z_turns(&'a self, z: S) -> Self {
    ...
    pub fn pitch(&'a self, pitch: S) -> Self {
    ...
    pub fn roll(&'a self, roll: S) -> Self {
        self.z_radians(roll)
    }
    ...
    pub fn rotate(&'a self, radians: S) -> Self {
        self.z_radians(radians)
    }

    /// Produce a new **Draw** instance that will draw with the given alpha blend descriptor.
    pub fn alpha_blend(&'a self, blend_descriptor: wgpu::BlendDescriptor) -> Self {
        let mut context = self.context.clone();
    ...
    pub fn color_blend(&'a self, blend_descriptor: wgpu::BlendDescriptor) -> Self {
        let mut context = self.context.clone();
    ...
    pub fn blend(&'a self, blend_descriptor: wgpu::BlendDescriptor) -> Self {
    ...
    pub fn scissor(&'a self, scissor: geom::Rect<S>) -> Self {
        let mut context = self.context.clone();
    ...
    pub fn triangle_mode(&'a self) -> Self {
    ...
    pub fn sampler(&'a self, desc: wgpu::SamplerDescriptor<'a>) -> Self {
        let mut context = self.context.clone();
    ...
    fn primitive_topology(&'a self, topology: wgpu::PrimitiveTopology) -> Self {
        let mut context = self.context.clone();
    ...
    fn context(&'a self, context: Context<'a, S>) -> Self {
    ...
    pub fn background(&'a self) -> Background<'a, S> {
        background::new(self)
    }
    ...
    pub fn path(&'a self) -> Drawing<'a, primitive::PathInit<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing an **Ellipse**.
    pub fn ellipse(&'a self) -> Drawing<'a, primitive::Ellipse<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing a **Line**.
    pub fn line(&'a self) -> Drawing<primitive::Line<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing an **Arrow**.
    pub fn arrow(&'a self) -> Drawing<primitive::Arrow<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing a **Quad**.
    pub fn quad(&'a self) -> Drawing<primitive::Quad<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing a **Rect**.
    pub fn rect(&'a self) -> Drawing<primitive::Rect<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing a **Triangle**.
    pub fn tri(&'a self) -> Drawing<primitive::Tri<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing a **Polygon**.
    pub fn polygon(&'a self) -> Drawing<primitive::PolygonInit<S>, S> {
        self.a(Default::default())
    }

    /// Begin drawing a **Mesh**.
    pub fn mesh(&'a self) -> Drawing<primitive::mesh::Vertexless, S> {
        self.a(Default::default())
    }
    ...
    pub fn polyline(&'a self) -> Drawing<primitive::PathStroke<S>, S> {
        self.path().stroke()
    }

    /// Begin drawing a **Text**.
    pub fn text(&'a self, s: &str) -> Drawing<primitive::Text<S>, S> {
        let text = {
    ...
    pub fn finish_remaining_drawings(&'a self) {
...
impl<'a, S> Default for State<'a, S>
where
    S: BaseFloat,
{
    fn default() -> Self {
...
impl<'a, S> Default for Context<'a, S>
where
    S: BaseFloat,
{
    fn default() -> Self {
